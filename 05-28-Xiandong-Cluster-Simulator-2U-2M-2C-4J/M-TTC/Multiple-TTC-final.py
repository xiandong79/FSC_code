...
if __name__ == "__main__":
    ...
    # agent "a" has the ownship of "house-type-1" with amount "20", and so on.
    initialOwnership = {
        'a': {0: 5, 1: 6, 2: 10, 3: 2, 4: 5},
        'b': {0: 3, 1: 2, 2: 5, 3: 8, 4: 3},
        'c': {0: 3, 1: 5, 2: 6, 3: 7, 4: 6},
        'd': {0: 3, 1: 4, 2: 2, 3: 1, 4: 1},
        'e': {0: 2, 1: 1, 2: 2, 3: 4, 4: 4},
    }

#     initialOwnership = {'a': {0: 5, 1: 6, 2: 10, 3: 2, 4: 5}, 'b': {0: 3, 1: 2, 2: 5, 3: 8, 4: 3}, 'c': {0: 3, 1: 5, 2: 6, 3: 7, 4: 6}, 'd': {0: 3, 1: 4, 2: 2, 3: 1, 4: 1}, 'e': {0: 2, 1: 1, 2: 2, 3: 4, 4: 4}}
# final_allocation = {'c': {0: 9, 1: 5, 3: 13}, 'd': {4: 8, 2: 3}, 'b': {2: 18, 3: 3}, 'a': {4: 11, 1: 6, 2: 2, 0: 7, 3: 2}, 'e': {1: 7, 2: 2, 3: 4}}
